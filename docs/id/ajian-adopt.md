...
pindah, ke mana, dan apa yang tetap di tempat. Kau menyetujuinya dokumen demi dokumen; ia
memindahkan hanya yang kau setujui, meninggalkan penunjuk di tempat asal, dan **tak pernah
...
- **Kau mewarisi proyek dengan dokumen sungguhan** — README panjang, PRD, `ARCHITECTURE.md`, wiki
  yang ikut di-commit, sisa Spec Kit atau framework lain — dan mau melanjutkannya dengan ajian.
- **Kau sudah pernah pakai ajian, lalu memperbarui skill-nya, dan sekarang ada tahap yang menolak**
...
- **Apakah README-ku akan ditulis ulang?** Hanya kalau kau menyetujui perpindahan itu secara
...
- **Bisa dibatalkan?** Bisa. Satu dokumen, satu commit, jadi pemetaan yang kau sesali cuma sejauh
